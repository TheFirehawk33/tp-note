...
public class OfferControllerTest {
    ...
    public void create_should_return_status_201() {
        StatusAndContent<CreateResponse> response = OfferUtils.createOffer(OfferBuilder.buildWithDescription("oui"));
    ...
    public void delete_should_return_status_204(){
        StatusAndContent<CreateResponse> response = OfferUtils.createOffer(OfferBuilder.buildWithDescription("testdelete"));
        assertThat(response.statusCode, is(201));
    ...
    public void get_should_return_status_204(){
        StatusAndContent<CreateResponse> response = OfferUtils.createOffer(OfferBuilder.buildWithDescription("testGet"));
        assertThat(response.statusCode, is(201));
